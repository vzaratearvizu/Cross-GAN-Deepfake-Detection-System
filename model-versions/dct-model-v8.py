...
X_test, y_test = build_features(TEST_REAL_DIR, TEST_FAKE_DIR, MAX_TEST, "(Stable Diffusion test)")
...
# ── Plot ──────────────────────────────────────────────────────────────────────
folder_path = experiments_folder("dct-model-v8-experiment")
...
plt.ylabel('Accuracy')
plt.title('Cross-GAN: StyleGAN2 (SFHQ) → Stable Diffusion')
plt.legend()
plt.grid(True)
